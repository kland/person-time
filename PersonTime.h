...
void PersonTime_Init(double sigma[], int m, double tau[], int n); /*defines the grid for the person-time calculation (m and n are the respective lengths of the arrays)*/
